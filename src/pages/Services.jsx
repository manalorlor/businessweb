          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="space-y-16">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-manatech-blue tracking-tight">Technical Lifecycle</h2>
              ...
              <div className="grid grid-cols-1 gap-12">
                {PROCESS_STEPS.map((step, idx) => (
                  <div key={step.title} className="flex gap-8 group">
                    <div className="w-16 h-16 rounded-2xl bg-white shadow-xl shadow-slate-200/50 flex items-center justify-center text-3xl font-bold text-manatech-blue transition-all duration-300 group-hover:bg-manatech-blue group-hover:text-white shrink-0">
                      0{idx + 1}
                    </div>
            ...
            <div className="space-y-12">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-manatech-blue tracking-tight">Frequently Asked</h2>
              </div>
