    ...
    <div className="flex flex-col w-full bg-white">
      ...
      <section className="container mx-auto px-6 py-24 mb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-manatech-blue p-16 rounded-[2.5rem] text-white flex flex-col justify-between min-h-[450px] shadow-2xl relative overflow-hidden group">
             ...
             <div className="space-y-6 mt-12 relative z-10">
                ...
                <p className="text-blue-100/80 leading-relaxed text-xl max-w-md">
          ...
          {/* Mission Block */}
          <div className="p-16 rounded-[2.5rem] flex flex-col justify-between min-h-[450px] border border-border/60 shadow-xl shadow-slate-200/50 bg-slate-50">
             <div className="space-y-6">
                <h3 className="text-3xl font-bold text-manatech-blue tracking-tight">OUR MISSION</h3>
             ...
             <div className="grid grid-cols-2 gap-4 mt-12">
               {[
                 ...
                 <div key={item.title} className="flex items-center gap-3 p-5 rounded-2xl bg-white shadow-md border border-border/40 transition-transform duration-300 hover:-translate-y-1">
                    <item.icon size={20} className={item.color} />
                    <span className="font-bold text-xs uppercase tracking-widest text-slate-800">{item.title}</span>
                 </div>
               ))}
             </div>
          </div>
      ...
      <section className="py-32 text-white relative overflow-hidden bg-manatech-blue">
        <div className="absolute inset-0 z-0">
           <img 
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mb-20 space-y-6 text-center mx-auto">
            <span className="text-xs font-bold text-white/40 uppercase tracking-[0.4em]">
              Operational Intelligence
            </span>
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight">Driven by Performance & Clarity.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="p-12 space-y-6 bg-white/5 backdrop-blur-md rounded-[2.5rem] border border-white/10 hover:bg-white/10 transition-all duration-500 group">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              ...
              <div key={stat.label} className="space-y-2 group text-center lg:text-left">
                <div className="text-5xl md:text-6xl font-bold text-manatech-blue tracking-tighter transition-all duration-500 group-hover:text-slate-900">
                  {stat.value}
                </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-6 text-center space-y-10">
           <h3 className="text-4xl md:text-5xl font-bold text-manatech-blue tracking-tight leading-tight">
           ...
           <div className="flex justify-center gap-6 pt-4">
              <Button asChild size="lg" className="bg-manatech-blue text-white rounded-xl px-12 h-16 text-sm font-bold uppercase tracking-widest shadow-2xl transition-all hover:-translate-y-1">
